"""
Django settings for grrrr_42102 project.
...
WSGI_APPLICATION = 'grrrr_42102.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "grrrr_42102 API",
    "DESCRIPTION": "API documentation for grrrr_42102 App",
    "VERSION": "v1",
}
